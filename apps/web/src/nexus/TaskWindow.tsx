 ...
 * container floating over the Construct. The title rail is the drag handle;
 * pointerdown anywhere raises the pane; ⇱ jumps to the task's full page.
 * Keyboard: rail is focusable — arrows nudge (Shift = 1px), Escape closes.
 */
